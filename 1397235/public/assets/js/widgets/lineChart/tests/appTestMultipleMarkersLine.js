 ...
 * This example shows lines with multiple markers and different symbols
 *
    ...
    var LineChartView = Backbone.View.extend({
        ...
        render: function () {
            ...
            var options = {
                ...
                // Enable multiple marker symbols
                markers: {
                    enabled: true,
                    multiple: true //multiple marker symbols eg. circle, square, triangle
                },
