/**
 * A view that uses the Form Widget to render a form from a configuration object for the Source Address view
 *
    ...
    var SourceAddressView = Backbone.View.extend({
        ...
        getViewData: function (){
            ...
            if (this.form && this.form.isValidInput()){
                ...
                viewData['source-address'] = this.getListBuilderSelectedItems('source-address');
            }
            return viewData;
        },
