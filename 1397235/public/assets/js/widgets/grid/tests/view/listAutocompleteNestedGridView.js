...
//                deleteEvent:"DeleteFirewallPolicies",
        ...
        render: function () {
            this.gridWidget = new GridWidget({
                container: this.el,
                elements: gridConfiguration.listNestedGrid,
                actionEvents:this.actionEvents
            }).build();
            this.bindFocusSearchInput();
            this.gridWidget.toggleGridHeader(undefined, "search");
            return this;
        },
...
//                    console.log(self.actionEvents.selectedEvent + " : ");
                    ...
                    if (selectedRows && selectedRows.numberOfSelectedRows) {
                        self.options.updateDescription(selectedRows.selectedRows[0].name);
//                        self.$el.hide();
                    }
                })
        },
