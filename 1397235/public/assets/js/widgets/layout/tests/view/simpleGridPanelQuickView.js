 ...
 * It contains a grid that allows to open another panel with a row quick view on the click of the quick view icon. It also allows to open a new panel with a grid on the click of the openPanel button.
 *
 * @module GridView
...
//                "PSP", //PSP is a filtered value
        ...
        render: function () {
            ...
            gridConfiguration.subTitle = "Click Quick View on Row or Button"
        ...
        bindGridEvents: function () {
            ...
            this.$el
                ...
                .bind(this.actionEvents.quickViewEvent.name, function(e, quickViewRow){
                    ...
                    self.options.updateQuickView(new QuickView({
