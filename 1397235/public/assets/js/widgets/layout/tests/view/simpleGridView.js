 ...
 * It contains a simple grid with a openPanel button that allows to open another panel.
 *
 * @module GridView
...
define([
    ...
    'mockjax'
], function(Backbone, GridWidget, configurationSample, ZonePoliciesAddView, GridOverlayView, ZonePoliciesModel, firewallPoliciesData, SmallGrid, QuickView, rbacData, mockjax){
    var GridView = Backbone.View.extend({
        ...
        initialize: function () {
            ...
            this.actionEvents = {
                ...
                openPanel:"openPanel",
                toggleMaximizePanel:"toggleMaximizePanel",
        ...
        render: function () {
            var self = this;
            var gridConfiguration = $.extend(true, {}, configurationSample.simpleGrid);
            gridConfiguration.subTitle = "New Panel";
            delete gridConfiguration.title;

            gridConfiguration.actionButtons.customButtons.push({
                "button_type": true,
                "label": "Toggle Maximize",
                "key": "toggleMaximizePanel"
            });
...
//                rbacData: rbacData
        ...
        bindGridEvents: function () {
            ...
            this.$el
                ...
                .bind(this.actionEvents.openPanel, function(e, movedGridRow){
                    self.options.updatePanel(new SmallGrid());
                })
                .bind(this.actionEvents.toggleMaximizePanel, function(e, movedGridRow){
                    self.options.toggleMaximizePanel();
                })
