...
], function(Backbone, OverlayWidget, FormWidget, formConfiguration, ListBuilderWidget, listBuilderConf){
...
//            this.getData(formValues);
            ...
            var service = this.$el.find('#service');
