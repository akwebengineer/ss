/**
 * Utility methods which generates matrix for the provided data, handles data updates and provides d3 interpolations for chord animations.
 *
...
define([], function () {
    ...
    matrix.groups = function () {
        return chordLayout.groups().map(function (group) {
            ...
            group.node = indexHash[group._id];
            return group;
        });
    };
