 ...
 * a list builder for url category
 *
 * @module UrlCategoryListBuilderConfiguration
        ...
        this.getValues = function(listBuilderModel) {
            ...
            return {
                "availableElements": {
                    ...
                    "totalRecords": "url-category-lists." + RestApiConstants.TOTAL_PROPERTY
                },
                "selectedElements": {
                ...
                "ajaxOptions": {
                    "headers": {
                        "Accept": 'application/vnd.juniper.sd.utm-management.url-category-list-refs+json;version=1;q=0.01'
                    }
                },
                "sorting": [{
                    "column": "name",
