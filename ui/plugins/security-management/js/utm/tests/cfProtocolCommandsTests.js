define([
        '../../../../security-management/js/utm/views/contentFilteringProtocolCommandFormView.js',
        '../../../../security-management/js/utm/models/contentFilteringModel.js'
], function(CfProtocolView, CfModel) {

    describe("contentFilteringProtocolCommandFormView unit-tests", function() {
                ...
                before(function () {
                    ...
                    view = new CfProtocolView(viewParams);
                ...
                it("view getTitle function works fine", function() {
                    ...
                    title.should.be.equal('utm_content_filtering_protocol_commands:');
                });
                ...
                it("view getSummary works fine", function() {
                    ...
                    summary[0].label.should.be.equal('utm_content_filtering_protocol_commands');
                });
