...
define([
	...
	var EmailAlertView = RecipientsWidget.extend({
	    ...
	    //
	    getSummary: function() {
            return this.generateSummary('ev_create_alert_email_page_summary');
        },
        //
        ...
        setEmailInfo: function(properties) {
            ...
            jsonDataObj = {
               ...
               "custom-message": properties['comments']
            };
            return jsonDataObj;
        },
        //
