/**
 * UT for access Profile wizard view
 *
...
define([
    ...
    describe('Access Profile Wizard view UT', function () {
        ...
        it('Checks if the Access Profile Wizard view object is created properly', function () {
            view.should.exist;
        });
        it('Checks if the Access Profile Wizard view object is created properly', function () {
            activity.getIntent=function(){
        ...
        describe('Access Profile Wizard view UT', function () {
            ...
            it('Checks if the Access Profile Wizard view Render', function () {
                view.render();
        ...
        describe('Access Profile Wizard view UT', function () {
            ...
            it('Checks if the Access Profile Wizard view wizardOnDone', function () {
                view.wizardOnDone();
        ...
        describe('Access Profile Wizard view UT', function () {
            ...
            it('Checks if the Access Profile Wizard view overlayDestroy', function () {
                view.overlayDestroy();
        ...
        describe('Access Profile Wizard view UT', function () {
            ...
            it('Checks if the Access Profile Wizard view overlayDestroyAll', function () {
        ...
        describe('Access Profile Wizard view UT saveModel ', function () {
            var save;
            before(function () {
