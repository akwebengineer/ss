/**
 * A module that launches create active directory domain LDAP grid.
 *
 * @module ActiveDirectoryDomainLDAPGridView
    ...
    var DomainControllerGridView = Backbone.View.extend({
        ...
        buildGrid: function () {
            var self = this,
                ...
                container = self.parentView.$el.find('#active_directory_domain_ldap').empty();
            ...
            // add css
           // container.find(".overlay_content").addClass("user-firewall-management");
