/** 
 * A Backbone model representing right panel details.
 *
 * @module RightPanelModel
...
define([
    ...
    /** 
     * RightPanelModel definition.
     */
    var RightPanelModel = Backbone.Model.extend({
        defaults: function() {
            return {
        ...
        fetch: function(options) {
            ...
            var ipsFilters = RequestConfig.getIPSThreatFilters();
            var avFilters = RequestConfig.getAntivirusThreatFilters();
            var asFilters = RequestConfig.getAntispamThreatFilters();
            var daFilters = RequestConfig.getDeviceAuthThreatFilters();
            
            $.when(
                RequestData.getAggregatedCount(timeRange, srcCountryFilters, ipsFilters),
