/**
 * ListBuilder for Interface selection
 *
...
define([
    ...
    '../conf/protectedInterfaceListBuilderConfiguration.js',
    '../models/protectedInterfaceListBuilderModel.js'
], function (Backbone, ListBuilder, ListBuilderConf, ListBuilderModel) {
    var isSetFilter = false;
    var InterfaceListBuilder = ListBuilder.extend({
        ...
        // Overwrite this method, as Interfaces have name only and request body data structure is different than base list builder.
        ...
        // Overwrite this method, as framework widget only requires an array of strings.
