/**
 *
 * @module ModifyGeneralSettingsVpnModel
...
define([
     ...
     */
    var ModifyGeneralSettingsVpnModel = SpaceModel.extend({
        urlRoot: '/api/juniper/sd/vpn-management/vpn-ui/ipsec-vpns/modify-general-settings?ui-session-id=',
    ...
    return ModifyGeneralSettingsVpnModel;
});