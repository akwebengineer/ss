...
define([
    ...
    var SourceZoneEditorView = ZoneEditorView.extend({
        initialize: function () {
            this.options.columnName == 'source-zone';
        ...
        getZones :function(){
            if(this.model.get("source-zone")){
                return this.model.get("source-zone");
            }
            return "";
        },
        ...
        getTitleHelp : function(){
            return {
                    "content": this.context.getMessage("rulegrid_column_srczone_title_info_tip"),
                ...
                success :function(collection, response, options){
                    ...
                    if(zones.length === 0){
                         if(zoneName && zoneName != 'any'){
                            selectData.push({id:zoneName,text:zoneName,type:zoneType});
                         } else {
