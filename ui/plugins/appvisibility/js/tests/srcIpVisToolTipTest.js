define(["../../../appvisibility/js/views/sourceipvisibility/sourceIpVisibilityToolTip.js"], function(SrcIPToolTip){

	describe("Source IP Bubble View Tool Tip Tests", function(){
		//
        var $el = $("#test_widget"),
		...
		before(function(){
			$.mockjax({
				"url": "/api/juniper/appvisibility/application-statistics/user-detail?user-name=10.208.9.44&start-time=" + startTime + "&end-time=" + endTime,
		...
		//
		describe("Source IP Bubble View Tool Tip creation", function(){

			toolTipView = new SrcIPToolTip({
												"context": context,
												"activity": activity,
												"data":{
													"name": "10.208.9.44",
