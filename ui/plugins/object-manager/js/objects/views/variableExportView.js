/**
 * View to export variable CSV file
 * 
 * @module VariableExportView
...
], function (Backbone, OverlayWidget, ConfirmationDialog, progressBarForm, SampleLinkTemplate) {
    var EXPORT_URL = '/api/juniper/sd/variable-management/variable-definitions/export-variables';
    var EXPORT_ACCEPT = 'application/vnd.net.juniper.space.job-management.task+json;version=1;q=0.01';
    var EXPORT_CONTENT = 'application/vnd.juniper.sd.variable-management.variable-export+json;version=1;charset=UTF-8';

    var VaribaleExportView = Backbone.View.extend({
        ...
        initialize: function(options) {
            ...
            var conf = {
                    title: this.context.getMessage('variable_export'), 
                    question: this.context.getMessage('variable_export_confirm'),
        ...
        showProgressBar: function(jobID) {
            this.progressBar = new progressBarForm({
                ...
                "title": this.context.getMessage("variable_export_window_title"),
                "fileType": this.context.getMessage("variable_export_file"),
                "hasPercentRate": true,
                "parentView": this,
                "jobID": jobID
            });
