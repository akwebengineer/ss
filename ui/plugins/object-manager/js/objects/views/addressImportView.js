/**
 * View to import address CSV file
 * 
 * @module AddressImportView
...
define([
    ...
    var CSV_SAMPLE_URL = '../installed_plugins/sd-common/js/common/csv/AddressImportSample.csv';
    var importModel = new ImportModel();

    var AddressImportView = Backbone.View.extend({
        events: {
            'click #address-import-save': "submit",
            'click #address-import-cancel': "cancel"
        },
        ...
        submit: function(event) {
            ...
            var self = this;
            var input = this.$el.find("#address-import-form").find(".fileupload")[0];
        ...
        render: function() {
            ...
            this.$el.find('#address-import-sample').html(Slipstream.SDK.Renderer.render(SampleLinkTemplate, templateData));

            // Add post_validation to validate selected file name
            this.$el.find('#address-import-area').bind('validateFileName', $.proxy(this.validateFileName, this, "address-import-area"));
